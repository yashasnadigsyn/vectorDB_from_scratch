...
class HNSWHeuristic:
    def __init__(self, M=16, Mmax=None, Mmax0=None, efConstruction=200, ef=50, mL=None, extendCandidates=False, keepPrunedConnections=False):
        self.M = M
    ...
    def insert(self, sentences):
        ...
        for vec in vectors:
            ...
            for lc in range(min(L, l), -1, -1):
                ...
                neighbors = self._select_neighbors_heuristic(vec, candidates, self.M, lc)
